...
image::DisplaySequenceDiagram.png[width=400]
...
.. Test case: +
    ...
    `add n/Norman ic/S0000010A p/98765432 e/johnd@example.com a/311, Clementi Ave 2, #02-25 dob/12.12.2000 g/Male` +
...
.. Test case: +
    ...
    `add n/Sally ic/S0000010B p/98765432 e/johnd@example.com a/311, Clementi Ave 2, #02-25 dob/12.12.2000 g/Female` +
